...
const StudentAddInfoPage = ({
    ...
    return (
        <div className='student-reg-page'>
            <P
                text='Student additional information'
                className='p-student-add-info'
            />
            <form onSubmit={userFormOnSubmitHandler}>
                ...
                {studies === 'yes' && (
                    <Input
                        ...
                        onChangeHandler={(evt) =>
                            setStudyPlace(evt.target.value)
                        }
                    />
                )}
                ...
                {works === 'yes' && (
                    <Input
                        ...
                        classNameDiv='student-answer-input'
                        onChangeHandler={(evt) =>
                            setStudentWorkPlace(evt.target.value)
                        }
                    />
                )}

                <P
                    text='Have you learn any programming language before?'
                    className='p-student-question'
                />
                <div className='student-question-answer-div'>
                    <InputRadio
                        label='Yes'
                        ...
                        classNameDiv='student-answer-div'
                        onChangeHandler={(evt) =>
                            setStudiedProgrammingLanguage(evt.target.value)
                        }
                    />
                    <InputRadio
                        label='No'
