...
const TeacherAddInfoPage = ({
    ...
    return (
        <div className="teacher-add-info-page">
            <P text="Teacher additional information" className="p-teacher-add-info" />
            <form onSubmit={userFormOnSubmitHandler}>
                ...
                <Input type="text" 
                       ...
                       classNameDiv="input-teacher-add-info" 
                       onChangeHandler={(evt) => setExperienceTime(evt.target.value)} />

                <P text="What type of languages do you know?" className="p-language-types-text" />
