            ...
            <div className='main-registration-page'>
                ...
                <div className='form-content'>
                    <form onSubmit={mainFormOnSubmitHandler}>
                        ...
                        {showRoleError && (
                            <P
                                className='role-error-text'
                                text='Please choose your role before continue!'
                            />
                        )}
                    ...
                    <div className='reg-area-go-to-login-div'>
                        <Link
                            href='/login'
                            className='reg-area-go-to-login-link'
                        >
                            I already have an account
                        </Link>
                    </div>
                    <div className='reg-area-back-home-link-div'>
                        <Link href='/' className='reg-area-back-home-link'>
                            Back to home page
                        </Link>
                    </div>
                </div>
